...
Car.prototype.accelerate = function (sp) {
  this.speed += sp;
  console.log(
...
Car.prototype.brake = function (br) {
  this.brake -= br;
  console.log(
...
const driveKm = myCar.drive.bind(myCar);
driveKm(100);
...
ElectricCar.prototype.toString = function () {
  return `${this.brand} ${this.model} ${this.year} - ${this.batteryCapacity} kWh`;
};
